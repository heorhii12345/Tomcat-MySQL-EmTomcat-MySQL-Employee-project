...
public class EmployeeController extends HttpServlet {
    ...
    private void create(HttpServletRequest request, HttpServletResponse response)
        ...
        String nameofemployee = request.getParameter("nameofemployee");
        String position = request.getParameter("position");
        double phone = Rounder.round(Double.parseDouble(request.getParameter("phone")), 2);
        Employee newEmployee = new Employee(nameofemployee, position, phone);
    ...
    private void update(HttpServletRequest request, HttpServletResponse response)
        ...
        String position = request.getParameter("position");
        double phone = Rounder.round(Double.parseDouble(request.getParameter("phone")), 2);
        Employee employee = new Employee(id, nameofemployee, position, phone);
